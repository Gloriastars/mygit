...
def load_data(file_path):
    ...
    for line in f.readlines():
        ...
        data.append(row)
    f.close()
    return np.mat(data)  # 打data转换成matrix
...
if __name__ == "__main__":
    k = 4  # 聚类中心的个数
    file_path = r"C:\\Users\\86153\\PycharmProjects\\shili1\\KSVD\\filed.txt"
    # 1、导入数据
    print ("---------- 1.load data ------------")
    ...
    save_result("C:\\Users\\86153\\PycharmProjects\\shili1\\KSVD\\kmeans\\sub", subCenter)
    # 5、保存聚类中心
    print ("---------- 5.save centroids ------------")
    save_result("C:\\Users\\86153\\PycharmProjects\\shili1\\KSVD\\kmeans\\center", centroids)